        ...
        <div className="container mx-auto px-4 py-4">
          <nav className="flex items-center justify-between">
            ...
            <div className="hidden md:flex items-center space-x-6">
              <Link href="/register" className="text-gray-600 hover:text-red-600 transition-colors">
                Register
              </Link>
              <Link href="/donors" className="text-gray-600 hover:text-red-600 transition-colors">
                Find Donors
              </Link>
              <Link href="/emergency" className="text-gray-600 hover:text-red-600 transition-colors">
                Emergency Request
              </Link>
              <Link href="/camps" className="text-gray-600 hover:text-red-600 transition-colors">
                Blood Camps
              </Link>
            </div>
          </nav>
